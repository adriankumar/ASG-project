...
class CTMLossManager:
    ...
    def compute_total_reward(self, sampled_text, target_text, concept_vectors):
        ...
        return total_reward, semantic_reward, token_reward, edit_reward, bleu_reward, consecutive_penalty, frequency_penalty
    ...
    def compute_policy_loss(self, concept_vectors, target_text):
        ...
        total_reward, semantic_reward, token_reward, edit_reward, bleu_reward, consecutive_penalty, frequency_penalty = self.compute_total_reward(sampled_text, target_text, concept_vectors)
        ...
        return policy_loss, total_reward, semantic_reward, token_reward, edit_reward, bleu_reward, consecutive_penalty, frequency_penalty
    ...
    def compute_trial_loss(self, concept_vectors, target_text, overall_confidence):
        policy_loss, total_reward, semantic_reward, token_reward, edit_reward, bleu_reward, consecutive_penalty, frequency_penalty = self.compute_policy_loss(concept_vectors, target_text)
        ...
        return trial_loss, policy_loss.item(), confidence_loss.item(), embedding_loss.item(), total_reward, semantic_reward, token_reward, edit_reward, bleu_reward, consecutive_penalty, frequency_penalty
...
class CTMMetricsTracker:
    ...
    def update_epoch_metrics(self, avg_loss, avg_confidence, avg_total_reward, avg_semantic_reward,
                           ...
                           avg_frequency_penalty, avg_policy_loss, avg_confidence_loss, avg_embedding_loss, 
                           avg_confidence_std, avg_windows_above_threshold):
...
def process_batch_parallel(model, batch_dict, loss_manager, 
    ...
    for trial_idx in range(batch_size):
        ...
        trial_loss, policy_loss, confidence_loss, embedding_loss, total_reward, semantic_reward, token_reward, edit_reward, bleu_reward, consecutive_penalty, frequency_penalty = loss_manager.compute_trial_loss(
...
def train_epoch(model, dataloader, loss_manager, optimizer, metrics_tracker, confidence_threshold=DEFAULT_CONFIDENCE_THRESHOLD):
    ...
    metrics_tracker.update_epoch_metrics(
        ...
        avg_edit_reward, avg_bleu_reward, avg_consecutive_penalty, avg_frequency_penalty,
